...
class Admin {
    ...
    public function load_scripts() {
        ...
        wp_register_script( 'wpvk-manifestt', WPVK_PLUGIN_URL . 'assets/js/chart.js', [], rand(), true );
        ...
        wp_register_script( 'chartjs', 'https://cdnjs.cloudflare.com/ajax/libs/Chart.js/3.3.2/chart.min.js', [ 'wpvk-chart' ], rand(), true );
